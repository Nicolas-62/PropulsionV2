 ...
 */
final class Version20230424135622 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article_data (id INT AUTO_INCREMENT NOT NULL, language_id INT DEFAULT NULL, object_id INT NOT NULL, field_key VARCHAR(255) NOT NULL, field_value LONGBLOB NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_1DB1746282F1BAF4 (language_id), INDEX IDX_1DB17462232D562B (object_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE language (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, ordre INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE article_data ADD CONSTRAINT FK_1DB1746282F1BAF4 FOREIGN KEY (language_id) REFERENCES language (id)');
        $this->addSql('ALTER TABLE article_data ADD CONSTRAINT FK_1DB17462232D562B FOREIGN KEY (object_id) REFERENCES article (id)');
        ...
        $this->addSql('ALTER TABLE online ADD CONSTRAINT FK_9E32BEEA2AADBACD FOREIGN KEY (langue_id) REFERENCES language (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article_data DROP FOREIGN KEY FK_1DB1746282F1BAF4');
        $this->addSql('ALTER TABLE article_data DROP FOREIGN KEY FK_1DB17462232D562B');
        ...
        $this->addSql('DROP TABLE article_data');

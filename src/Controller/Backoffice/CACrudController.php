...
use App\Field\MontantField;
use App\Field\MontantHTField;
use App\Field\MontantTTCField;
...
class CACrudController extends ProjetCrudController
{
    ...
    {
        $this->list_template_name = 'backoffice/projet/projets_montants.html.twig';
